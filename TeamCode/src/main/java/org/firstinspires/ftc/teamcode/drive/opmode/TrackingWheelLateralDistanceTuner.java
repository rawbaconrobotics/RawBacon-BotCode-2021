...
public class TrackingWheelLateralDistanceTuner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (!isStopRequested() && !tuningFinished) {
            ...
            packet.clearLines();
            packet.addLine("Total Heading (deg): " + Math.toDegrees(headingAccumulator));
            packet.addLine("Raw Heading (deg): " + Math.toDegrees(heading));
            packet.addLine("");
            packet.addLine("Press Y/△ to conclude routine");
            drive.update(packet);
